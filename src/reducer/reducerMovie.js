import { BEGIN_FETCH, FETCH_FAILED,FETCHED_MOVIES, OVERVIEW_MOVIE, FETCH_TRAILER, MOVIE_SUGGESTION, MOVIE_CREDITS, SEARCH_BY_QUERY_MOVIE, NOW_UPCOMING_MOVIE } from '../constants';
